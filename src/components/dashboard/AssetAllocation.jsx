            ...
            <svg viewBox="0 0 100 100" className="w-full h-full transform -rotate-90">
              {pieData.map((item, index) => (
                <motion.path
                  ...
                  onClick={() => setSelectedAsset(selectedAsset === item.id ? null : item.id)}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: index * 0.1 }}
                  style={{
                    filter: selectedAsset === item.id ? 'brightness(1.2)' : 'none'
                  }}
                />
              ))}
            </svg>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    />
                    <div className={`w-8 h-8 bg-gradient-to-br ${asset.gradient} rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                ...
                {isSelected && (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      {asset.subCategories.map((sub, subIndex) => (
                        <div key={subIndex} className="flex items-center justify-between text-sm">
                          ...
                          <div className="flex items-center space-x-2">
                            <span className="text-foreground">{sub.percentage}%</span>
                    ...
                    <Button variant="ghost" size="sm" className="mt-3 text-bs-blue-400">
        ...
        <div className="bg-gradient-to-r from-bs-blue-500/5 to-bs-purple-500/5 rounded-lg p-4 border border-bs-blue-500/10">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-foreground mb-2">Allocation Analysis</h4>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-muted-foreground">Risk Level</p>
                  <Badge variant="secondary" size="sm">Moderate-High</Badge>
                </div>
                <div>
                ...
                <div>
                  ...
                  <Badge variant="secondary" size="sm">Due in Q2</Badge>
                </div>
                <div>
